<template>
    ...
    <header class="fixed top-0 left-0 z-20 bg-white w-full shadow">
        <div class="flex gap-10 py-1 main-container justify-center">
    ...
    <nav class="flex justify-between py-4 main-container mt-14" >
        ...
        <div class="flex items-center gap-4 ">
            ...
            <span class="font-extrabold text-xl "> +998 99 999 99 99</span>
            <a-button type="primary" size="large" @click="showModal"> Заказать звонок</a-button>
        </div>
    </nav>
